...
public class MainActivity extends AppCompatActivity {
    ...
    Switch aSwitch;
    //由于两个进度条只做展示作用，所以不用进行交互，也就不用写变量来描述它们
    ProgressBar progressBar;
    EditText editText;
    RadioGroup radioGroup; //两个Radiobutton也不用给变量来描述
    ImageView imageView;
    SeekBar seekBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //采用匿名内部类的方式来设置监听器
        buttonLeft.setOnClickListener(new View.OnClickListener() {    //这里以匿名内部类的方式implement了View的一个接口
            @Override
